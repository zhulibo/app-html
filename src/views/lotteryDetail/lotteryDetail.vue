      ...
      getLotteryDetail() {
        ...
        this.$http({
          ...
          .then(res => {
            ...
            let nowTimeBeijingTimestamp = nowLocalTimestamp - hourOffset * 60 * 60 * 1000 // 此时北京时间戳

            if(nowTimeBeijingTimestamp > lotteryBeijingTimestamp) { // 开奖北京时间戳 - 此时北京时间戳
              this.countdownTime = 0
            } else {
              this.leftTime = (lotteryBeijingTimestamp - nowTimeBeijingTimestamp)/1000
              this.countdownTime()
            }
          })
      },
